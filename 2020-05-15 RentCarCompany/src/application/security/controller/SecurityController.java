...
public class SecurityController {
	...
	/*
	 * @PostMapping("/add_user") public AccountDto addUser(@RequestBody AuthPair
	 * authPair) { return service.addUser(authPair.getLogin(),
	 * authPair.getPassword()); };
	 */
	...
	/*
	 * @DeleteMapping("/remove_user") public AccountDto removeUser(String login) {
