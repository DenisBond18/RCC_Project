...
public class DtoService {
	...
	public CarDto getCarDto(Car car) {
		return new CarDto(car.getIdCar(), car.getModel().getIdModel());
	}
	public Driver getDriver(DriverDto driver) {
		return new Driver(driver.getIdDriver(),
				driver.getFirstName(),
				driver.getLastName(),
	...
	public DriverDto getDriverDto(Driver driver) {
		return new DriverDto(driver.getIdDriver(),
				driver.getFirstName(),
				driver.getLastName(),
	...
	public RentRecordDto getRentRecordDto(RentRecord record) {
		return new RentRecordDto(record.getIdRecord(),
	...
	private LocalDate parseLocalDate(String stringDate) {
		try {
			...
			throw new WrongStringDateFormatException("String date " + stringDate 
					+" does not match format " + dateTimeFormatter.toString());
		}	
	}
